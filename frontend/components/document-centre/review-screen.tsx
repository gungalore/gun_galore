...
import { DocThumb, GlyphThumb } from '@/components/document-centre/doc-thumb';
import {
  ReviewItem,
  expiryAnswer,
  needsALook,
...
// ⚠️ THE THUMBNAIL, ITS QUEUE AND ITS GLYPH FALLBACK NOW LIVE IN doc-thumb.tsx.
// They moved when the Document Centre grew a second surface that draws
// documents — the grid of safe photographs — because two copies of the gate
// would be two queues of two, which is four concurrent decrypting reads and
