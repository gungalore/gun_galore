// Regulated Items & Compliance — explains All Outdoor's role and the
...
export const metadata = {
  ...
  description:
    'Our role, your responsibilities, and the legal framework for regulated and licence-controlled items on All Outdoor, including firearms under the Firearms Control Act 60 of 2000.',
};
...
export default function RegulatedItemsAnnexPage() {
  return (
    <>
      ...
      <p>
        All Outdoor lists many categories, several of which are
      ...
      <ul>
        ...
        <li>Suppressors / sound moderators where their possession is restricted (refer to the FCA — note these are not normally listable on All Outdoor — see our{' '}
      ...
      <p>
        ...
        peer-to-peer between private individuals on All Outdoor. This
      ...
      <ol>
        ...
        <li><strong>Buyer confirms delivery</strong> on the All Outdoor transaction page, which releases the seller payout.</li>
      </ol>
      <p>
        All Outdoor is not party to the dealer's process and does not
      ...
      <ul>
        ...
        <li>The buyer expressly waives All Outdoor's payment-held protection at checkout, via a two-checkbox + typed-confirmation gate.</li>
      </ul>
      <p>
      ...
      <h2>11. All Outdoor's role and limitation</h2>
      <p>
        All Outdoor facilitates the discovery, negotiation and payment
