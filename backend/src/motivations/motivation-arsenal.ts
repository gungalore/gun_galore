...
export function arsenalBlock(rows: readonly ArsenalRow[]): string {
  ...
  return [
    ...
    'A row may carry one or more <uses for="…"> lists. Those say what a firearm',
    'of that CLASS is SUITED TO in South Africa — a fact about the calibre, not',
    'the applicant’s own words, and not read off any document.',
    '⚠️ THEY ARE NOT A RECORD OF WHAT THE APPLICANT HAS DONE, and you must not',
    'turn one into one. "My .300 Winchester Magnum is suited to plains game at',
    'moderate ranges" is true of every .300 ever made. "I hunt plains game with',
    'my .300" is a claim about this person that nothing in this pack supports,',
    'in a document they sign under section 120(9) of the Act. Keep the sentence',
    'about the FIREARM.',
